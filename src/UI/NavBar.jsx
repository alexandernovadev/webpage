...
export const NavBar = () => {
  return (
    <>
      <nav className="w3-sidebar w3-bar-block w3-small w3-hide-medium w3-hide-small w3-center">
        <img
        ...
        {menu_options.map(({ icon, name, to }) => (
          <NavLink
            key={name}
            to={to}
            className="navicon w3-bar-item w3-button w3-padding-large w3-black w3-hover-none">
